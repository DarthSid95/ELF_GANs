...
class ARCH_mnist():
	...
	def encdec_model_mnist_dense(self):  # FOR BASE AE
	...
	def show_result_mnist(self, images=None, num_epoch=0, show = False, save = False, path = 'result.png'):
		...
		images_on_grid = self.image_grid(input_tensor = reals_to_display, grid_shape = (self.num_to_print,self.num_to_print),image_shape=(self.output_size,self.output_size),num_channels=1)
